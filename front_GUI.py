...
class FrontFrame(ttk.Frame):
    def __init__(self, *args, **kwargs):
        ...
        ttk.Label(self, text="View the instructions on the tabs in order").grid(
        ...
        self.UseLoadParametersNotebook.add(
            self.geometry_circle_frame, text="Geometry Circle", padding=10
        )
        self.UseLoadParametersNotebook.add(
            self.geometry_ellipse_frame, text="Geometry Ellipse", padding=10
        )
        self.UseLoadParametersNotebook.add(
            self.stresses_frame, text="Stresses", padding=10
        )
        ...
        visualization_label = ttk.Label(
            self.UseVisualizationFrame, image=visualization_image
        )
        ...
        self.OptionsNotebook.add(
            self.UseLoadParametersFrame, text="Load Parameters", padding=10
        )
        self.OptionsNotebook.add(
            self.UseVisualizationFrame, text="Visualization", padding=10
        )
        self.OptionsNotebook.add(
            self.UseExportDataFrame, text="Export Data", padding=10
        )
